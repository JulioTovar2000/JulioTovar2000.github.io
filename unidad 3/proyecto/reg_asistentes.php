<?php
    ...
    if(isset($_POST['aceptar'])){
        $nombre = mysqli_real_escape_string($conexion, $_POST['myname']);
        $company = mysqli_real_escape_string($conexion, $_POST['companyname']);
        $email = mysqli_real_escape_string($conexion, $_POST['myemail']);
        $request = mysqli_real_escape_string($conexion, $_POST['requesttype']);
        $comment = mysqli_real_escape_string($conexion, $_POST['mycomments']);
        $hear = mysqli_real_escape_string($conexion, $_POST['reference']);

        
        $query = "INSERT INTO asistentes VALUES (NULL, '$nombre', '$company', '$email', '$request', '$comment', '$hear')";
